...
public:
    explicit Character(const int &index_character, const QVector<ToDoSingleStruct> &AllToDoList, QWidget *parent = nullptr, QString nick_name = "DefaultName", double score = 0);
    ~Character();
